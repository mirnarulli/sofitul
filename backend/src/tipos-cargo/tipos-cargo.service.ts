...
const TIPOS_CARGO_SEED = [
  ...
  { codigo: 'CARGO_PRORROGA', nombre: 'Cargo por prórroga',     categoria: 'PRORROGA',    aplicaEn: 'POR_CUOTA',        baseCalculo: 'MONTO_CUOTA',       porcentaje: null, montoFijo: null,  esObligatorio: false, permisoExonerar: null, orden: 6 },
];
