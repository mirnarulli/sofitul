...
import { MontoTable, ValorTable, RefTable, type MontoRow, type ValorRow } from './FinancialTables';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-3">
          ...
          <div className="flex gap-4">
            ...
            {data.declaracionFirmada && <Pill label="✓ Declaración firmada" color="green" size="md" />}
          </div>
        ...
        <div className="flex items-start gap-4 mb-5">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {pf.esPep   && <Pill label="PEP"   color="orange" bold />}
              {pf.esFatca && <Pill label="FATCA" color="purple" bold />}
